...
class ImmersiveSpaceManager: ObservableObject {
    ...
    private func dismissAllWindows() async {
        ...
        let windowIds = ["chatWindow", "emojiWindow", "movieWindow", "seatMap", "navBar", "mainContent"]
    ...
    private func showTabBar() {
        ...
        if !activeWindows.contains("mainContent") {
            openWindow("mainContent")
            activeWindows.insert("mainContent")
        }
    }
